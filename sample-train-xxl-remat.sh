...
export EXP_PREFIX=xxl-remat-max-batch
...
python3 t5x/train.py \
  ...
  --gin_file=/home/sivaibhav/t5x/t5x/configs/runs/pretrain-xxl-remat.gin \
  --gin_file=./t5x/examples/scalable_t5/t5_1_1/xxl-remat.gin \
