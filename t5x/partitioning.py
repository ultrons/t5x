...
def get_mesh(model_parallel_submesh: HardwareMesh,
  ...
  mesh_err = (
          f'each dimension of the model parallel submesh:{model_parallel_submesh} must be a factor of the '
      f'corresponding dimension of the global device mesh:{global_hardware_mesh}')
  assert not any(
      g % m
