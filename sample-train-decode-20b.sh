...
export EXP_PREFIX=5b_b96_2d_param_2d_activation
...
python3 t5x/train.py \
  ...
  --gin_file=/home/sivaibhav/t5x/t5x/configs/runs/pretrain-20b.gin \
  --gin_file=./t5x/examples/scalable_decoder_only/models/config-20b.gin \
